...
export default class StyleSettings {
	...
	static getAllStyle(){
		return [
			Extend.exterior( {}, this.getStyleResurgenceA(), this.returnSub( this.getStyleBlueskyA(), {padding: ReactGroupSetting.PADDING_TINY} ) ),
			Extend.exterior( {}, this.getStyleResurgenceB(), this.returnSub( this.getStyleResurgenceA(), {padding: ReactGroupSetting.PADDING_TINY} ) ),
			Extend.exterior( {}, this.getStyleResurgenceC(), this.returnSub( this.getStyleResurgenceB(), {padding: ReactGroupSetting.PADDING_TINY} ) ),
			
			Extend.exterior( {}, this.getStyleSpringA(), this.returnSub( this.getStyleWineA(), {padding: ReactGroupSetting.PADDING_TINY} ) ),
			...
			Extend.exterior( {}, this.getStyleWineA(), this.returnSub( this.getStyleSpringA(), {padding: ReactGroupSetting.PADDING_TINY} ) ),
			...
			Extend.exterior( {}, this.getStyleBlueskyA(), this.returnSub( this.getStyleResurgenceA(), {padding: ReactGroupSetting.PADDING_TINY} ) ),
			...
			Extend.exterior( {}, this.getStyleLovelyA(), this.returnSub( this.getStyleLuxuryA(), {padding: ReactGroupSetting.PADDING_TINY} ) ),
			...
			Extend.exterior( {}, this.getStyleLuxuryA(), this.returnSub( this.getStyleRigidA(), {padding: ReactGroupSetting.PADDING_TINY} ) ),
			...
			Extend.exterior( {}, this.getStyleFantasyA(), this.returnSub( this.getStyleWatersideA(), {padding: ReactGroupSetting.PADDING_TINY} ) ),
			...
			Extend.exterior( {}, this.getStyleRigidA(), this.returnSub( this.getStyleLovelyA(), {padding: ReactGroupSetting.PADDING_TINY} ) ),
			...
			Extend.exterior( {}, this.getStyleWatersideA(), this.returnSub( this.getStyleFantasyA(), {padding: ReactGroupSetting.PADDING_TINY} ) ),
	...
	static getStyleResurgenceA(){
		return {
			...
			method: {
				...
				iconPosition: ReactGroupSetting.ICON_POSITION_TOP,
	...
	static getStyleResurgenceC(){
		return {
			...
			method: {
			    ...
			    listPosition: ReactGroupSetting.LIST_POSITION_INNER,
			    iconPosition: ReactGroupSetting.ICON_POSITION_BOTTOM,
			    iconShow: [ReactGroupSetting.ICON_SHOW_STAR],
			    styleName: ReactGroupSetting.STYLE_NAME_RESURGENCE,
	...
	static getStyleSpringA(){
		return {
			...
			method: {
			    ...
			    // listStyle: ReactGroupSetting.LIST_STYLE_CIRCLE,
			    listPosition: ReactGroupSetting.LIST_POSITION_OUTER,
			    iconPosition: ReactGroupSetting.ICON_POSITION_RIGHT,
