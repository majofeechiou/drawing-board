...
export default class Settings {
	...
	static METHOD_LOOKS_WINE_A = 'METHOD_LOOKS_WINE_A';
	static METHOD_LOOKS_WINE_B = 'METHOD_LOOKS_WINE_B';
	static METHOD_LOOKS_WINE_C = 'METHOD_LOOKS_WINE_C';

	static METHOD_LOOKS_BLUESKY_A = 'METHOD_LOOKS_BLUESKY_A';
	static METHOD_LOOKS_BLUESKY_B = 'METHOD_LOOKS_BLUESKY_B';
	static METHOD_LOOKS_BLUESKY_C = 'METHOD_LOOKS_BLUESKY_C';

	static METHOD_LOOKS_LOVELY_A = 'METHOD_LOOKS_LOVELY_A';
	static METHOD_LOOKS_LOVELY_B = 'METHOD_LOOKS_LOVELY_B';
	static METHOD_LOOKS_LOVELY_C = 'METHOD_LOOKS_LOVELY_C';
	...
	static METHOD_LOOKS_FANTASY_A = 'METHOD_LOOKS_FANTASY_A';
	static METHOD_LOOKS_FANTASY_B = 'METHOD_LOOKS_FANTASY_B';
	static METHOD_LOOKS_FANTASY_C = 'METHOD_LOOKS_FANTASY_C';

	static METHOD_LOOKS_RIGID_A = 'METHOD_LOOKS_RIGID_A';
	static METHOD_LOOKS_RIGID_B = 'METHOD_LOOKS_RIGID_B';
	static METHOD_LOOKS_RIGID_C = 'METHOD_LOOKS_RIGID_C';

	static METHOD_LOOKS_WATERSIDE_A = 'METHOD_LOOKS_WATERSIDE_A';
	static METHOD_LOOKS_WATERSIDE_B = 'METHOD_LOOKS_WATERSIDE_B';
	static METHOD_LOOKS_WATERSIDE_C = 'METHOD_LOOKS_WATERSIDE_C';
